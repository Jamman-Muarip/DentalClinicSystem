...
<div class="container-fluid">
    <div class="row" id="location_modal">
        <div class="col-6 border-left" id="frm-field">
            <h3>Patient Information: (<?php echo $_GET['d'] ?>)</h3>
            <hr>
			...
			$.ajax({
				...
				success:function(resp){
					if(typeof resp =='object' && resp.status == 'success'){
                        ...
                        var ins = "<small><i>Copy or take a snapshot of the code below your name. The code will serve as your ticlet number for dental clinic schedule. Please bring atleast 1 ID to verify your schedule information.</i></small>";
